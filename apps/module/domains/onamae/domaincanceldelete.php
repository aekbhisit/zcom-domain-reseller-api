<?php
class onamae_domaincanceldelete extends core_api {
	var $array;
	var $query_string;
	var $params;
	var $data;
	...
	public function get ($params) {
		...
		$this->data = array(
			...
			"actionType"=>"DomainCancelDelete",
			"responseFormat"=>domain_api::$responseFormat
		);
		$this->flag_domain = '';
		$this->checkValidateParams();
		return $this->onamae_DomainCancelDelete();
	}
	public function onamae_DomainCancelDelete () {
