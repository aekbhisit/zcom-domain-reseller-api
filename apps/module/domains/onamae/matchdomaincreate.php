<?php
class onamae_matchdomaincreate extends core_api {
	var $array;
	var $query_string;
	var $params;
	var $data;
	...
	public function get ($params) {
		...
		$this->data = array(
			...
			"actionType"=>"MatchDomainCreate",
			"responseFormat"=>domain_api::$responseFormat
		);
		$this->flag_domain = '';
		$this->checkValidateParams();
		return $this->onamae_MatchDomainCreate();
	}
	public function onamae_MatchDomainCreate () {
